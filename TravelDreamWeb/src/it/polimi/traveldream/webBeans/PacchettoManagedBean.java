...
public class PacchettoManagedBean {
	...
	/**
	 * Metodo che ritorna true se una data selezione è possibile false altrimenti  
	 * @return un booleano che è true se la selezione è possibile false altrimenti 
	 */
	...
	/**
	 * Metodo che si occupa di validare le date e di verificare se la data di fine validità è successiva a quella di inizio
	 * @param context
	 * @param component
	 * @param value
	...
	/**
	 * Metodo che valida l'id se non è già utilizzato 
	 * @param context
	 * @param component
	 * @param value
	 * @throws ValidatorException
