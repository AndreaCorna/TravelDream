...
public class GestionePacchettoBeanImpl implements GestionePacchettoBean {
	...
	/** 
	 * metodo che verifica se la data di ritorno � dopo quella della partenza di un dato aereo
	 * @param aereo
	 * @param partenza
	 * @return true se il vincolo � rispettato
	 */
	...
	/**
	 * Metood che verifica se la data di andata � prima di quella di ritorno di un dato aereo 
	 * @param aereo
	 * @param ritorno
	 * @return true se il vincolo � rispettato 
	 */
	 ...
	 * @return un booleano che � true se vi sono posti disponibili
	 */
	@SuppressWarnings("unchecked")
