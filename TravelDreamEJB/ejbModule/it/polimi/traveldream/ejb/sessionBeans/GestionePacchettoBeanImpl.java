...
public class GestionePacchettoBeanImpl implements GestionePacchettoBean {
	...
	/**
	 * Metodo che restituisce la lista degli aerei prenotabili data la citt‡ di destinazione
	 */
	@SuppressWarnings("unchecked")
	@Override
	@RolesAllowed({"DIPENDENTE","UTENTE"})
	 ...
	 * @param hotel di cui si vuole verificare la disponibilit‡
	...
	/** 
	 * metodo che verifica se la data di ritorno Ë dopo quella della partenza di un dato aereo
	 * @param aereo
	 * @param partenza
	 * @return true se il vincolo Ë rispettato
	 */
	...
	/**
	 * Metood che verifica se la data di andata Ë prima di quella di ritorno di un dato aereo 
	 * @param aereo
	 * @param ritorno
	 * @return true se il vincolo Ë rispettato 
	 */
	 ...
	 * @return un booleano che Ë true se vi sono posti disponibili
	 */
	@SuppressWarnings("unchecked")
