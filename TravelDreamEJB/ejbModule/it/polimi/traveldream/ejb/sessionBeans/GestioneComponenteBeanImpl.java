...
public class GestioneComponenteBeanImpl implements GestioneComponenteBean {
	...
	/**
	 * metodo che dato l'id di un aereo permette di restituire un booleano che � true se 
	...
	/**
	 * metodo che dato l'id di un hotel permette di restituire un booleano che � true se 
	...
	/**
	 * metodo che dato l'id di un'escursione permette di restituire un booleano che � true se 
	...
	/**
	 * Metodo che prende un aereo che � stato modificato e si occupa di integrare le modifiche
	...
	/**
	 * Metodo che prende un hotel che � stato modificato e si occupa di integrare le modifiche
	 *  all'interno del database
	 */
	@Override
	@RolesAllowed({"DIPENDENTE"})
	...
	/**
	 * Metodo che prende un'escursione che � stata modificata e si occupa di integrare le modifiche
	 *  all'interno del database
	 */
	@Override
	@RolesAllowed({"DIPENDENTE"})
	...
	/**
	 * Metodo che restituisce se un dato pacchetto � provvisto sia di aereo di andata che di ritorno
	 * @param pacchetto
	 * @return booleano che � true se l'aereo ha un ritorno
	 */
