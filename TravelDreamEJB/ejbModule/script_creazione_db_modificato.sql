...
CREATE  TABLE IF NOT EXISTS `TravelDreamDB`.`Utente` (
  ...
  `id_Anagrafica` VARCHAR(16) NOT NULL ,
  `id_Amministratore` INT NULL ,
  PRIMARY KEY (`id`) ,
  INDEX `fk_Utente_Registrato_Anagrafica` (`id_Anagrafica` ASC) ,
  UNIQUE INDEX `Username_UNIQUE` (`Username` ASC) ,
  INDEX `fk_Utente_Amministratore` (`id_Amministratore` ASC) ,
  CONSTRAINT `fk_Utente_Registrato_Anagrafica`
    FOREIGN KEY (`id_Anagrafica` )
    REFERENCES `TravelDreamDB`.`Anagrafica` (`CF` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Utente_Amministratore`
...
CREATE  TABLE IF NOT EXISTS `TravelDreamDB`.`Pacchetto` (
  ...
  CONSTRAINT `fk_Pacchetto_Dipendente1`
    ...
    REFERENCES `TravelDreamDB`.`Utente` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `TravelDreamDB`.`Gruppo`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `TravelDreamDB`.`Gruppo` (
...
-- -----------------------------------------------------
-- Table `TravelDreamDB`.`Gruppo_Utente`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `TravelDreamDB`.`Gruppo_Utente` (
  `id_Utente` INT NOT NULL ,
  `id_Gruppo` VARCHAR(40) NOT NULL ,
  PRIMARY KEY (`id_Utente`, `id_Gruppo`) ,
  INDEX `fk_Utente_has_Gruppo_Gruppo1` (`id_Gruppo` ASC) ,
  INDEX `fk_Utente_has_Gruppo_Utente1` (`id_Utente` ASC) ,
  INDEX `fk_Utente_has_Gruppo_Amministratore` (`id_Utente` ASC) ,
  ...
  CONSTRAINT `fk_Utente_has_Gruppo_Gruppo1`
    ...
    REFERENCES `TravelDreamDB`.`Gruppo` (`nome` )
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fk_Utente_has_Gruppo_Amministratore`
    FOREIGN KEY (`id_Utente` )
    REFERENCES `TravelDreamDB`.`Amministratore` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
